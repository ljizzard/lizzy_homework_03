...
sorted_lotter_numbers = eriks_lottery_numbers.sort()
...
# 6. Return an array of Avril's lottery numbers that are even
 ...
 even_numbers = []
  for lottery_numbers in avrils_lottery_numbers
    if lottery_numbers.even?
...
# 10. Add another person to the users hash
 # create new user:
 # users["Gemma"] ={ hash info as per above}
